...
type Satellite interface {
	 ...
	 */
	WillBeSeen(qth *GroundStationPosition) bool
	 ...
	 *            of the satellite.
	 */
	CalculateSatelliteVectors(t time.Time)
	 ...
	 *         satellite is stored.
	 */
	CalculateSatelliteGroundTrack() SatPos
	 ...
	 */
	CalculateSatPosForGroundStation(gsPos *GroundStationPosition) SatPos
